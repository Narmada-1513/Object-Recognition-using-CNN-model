...
def capture_plate(video):
    ...
    while True:
        ...
        if fcount == 22:
            cv2.imwrite(
                "C:/Users/anshk/Summer Training/numberplate_web-main/numberplate_web-main/site/static/styles/carcont.jpeg", frames)
            s = 1
        if s == 1:
            pytesseract.pytesseract.tesseract_cmd = r'C:\Program Files\Tesseract-OCR\tesseract.exe'
            img = cv2.imread(
                'C:/Users/anshk/Summer Training/numberplate_web-main/numberplate_web-main/site/static/styles/carcont.jpeg', cv2.IMREAD_COLOR)
            ...
            if detected == 1:
                ...
                cv2.imwrite(
                    "C:/Users/anshk/Summer Training/numberplate_web-main/numberplate_web-main/site/static/styles/number.jpeg", Cropped)
                string = pytesseract.image_to_string(
                    Cropped, config='--psm 11')
...
def Car_info(text):
    ...
    username = "Anshkumardev"  # insert your user name
    url = "http://www.regcheck.org.uk/api/reg.asmx/CheckIndia?RegistrationNumber=" + \
        vehicle_reg_no + "&username="+username
    url = url.replace(" ", "%20")
    r = requests.get(url)
